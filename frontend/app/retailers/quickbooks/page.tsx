...
export default function RetailerQuickBooksPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">QuickBooks Integration</h1>
            <p className="text-gray-400">Connect your retailer account and run accounting sync operations.</p>
          </div>
          <Link
            href="/retailers"
