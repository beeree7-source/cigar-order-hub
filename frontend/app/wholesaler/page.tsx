  ...
  const loadDashboard = async () => {
    try {
      const [appsRes, appTemplatesRes] = await Promise.all([
        fetch('http://localhost:10000/api/wholesaler/retailer-applications?status=pending', {
          headers: { Authorization: `Bearer ${token}` }
        }),
        fetch('http://localhost:10000/api/wholesaler/applications', {
          headers: { Authorization: `Bearer ${token}` }
        })
      ]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/wholesaler/approved-retailers"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <Link href="/wholesaler/retailer-applications">
          ...
          <Link href="/wholesaler/applications">
        ...
        <div className="bg-gray-800 rounded-lg p-8 border border-gray-700 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-11 gap-4">
            ...
            <Link href="/wholesaler/subscription">
            ...
            <Link href="/wholesaler/quickbooks">
            ...
            <Link href="/wholesaler/inventory-import">
            ...
            <Link href="/wholesaler/inventory-import?template=csv">
            ...
            <Link href="/wholesaler/approved-retailers">
              <button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 px-6 rounded-lg transition-colors text-left">
