  ...
  const loadDashboard = async (token: string) => {
    try {
      const [approvedRes, applicationsRes, licensesRes] = await Promise.all([
        fetch('http://localhost:10000/api/retailer/approved-suppliers', {
          headers: { Authorization: `Bearer ${token}` }
        }),
        fetch('http://localhost:10000/api/retailer/applications', {
          headers: { Authorization: `Bearer ${token}` }
        }),
        fetch('http://localhost:10000/api/retailer/licenses', {
          headers: { Authorization: `Bearer ${token}` }
        })
      ]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/retailer/approved-sales-reps"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Link href="/retailer/approved-suppliers">
          ...
          <Link href="/retailer/applications">
